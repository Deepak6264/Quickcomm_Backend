...
router.post(
  ...
  function (req, res) {
    try {
      pool.query(
        "insert into product(categoryid, subcategoryid, brandid, productname, productdescription, producticon, created_at, updated_at, user_admin)value(?,?,?,?,?,?,?,?,?)",
        [
          req.body.categoryid,
...
router.post(
  ...
  function (req, res) {
    try {
      pool.query(
        "update product set producticon=?,updated_at=?,user_admin=? where productid=?",
        [
          req.file.filename,
          req.body.updated_at,
          req.body.user_admin,
